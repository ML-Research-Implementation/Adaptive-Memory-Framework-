...
print("=" * 60)
print("Contextual Output Shape:", contextual_vectors.shape) 
...
teacher_logits = torch.randn(1, 30522) * 2.0  
student_logits = torch.randn(1, 30522) * 1.5  
true_label = torch.tensor([3435])             
